...
{
    internal class WebActionResultCookieMessageActionFilterHandler : IWebActionResultCookieMessageActionFilterHandler
    {
        ...
        public WebActionResultCookieMessageActionFilterHandler(
